...
const courseSectionSchema = require("./CourseModels/CourseSectionSchema.model");
const resourceSchema = require("./CourseModels/ResourceSchema.model");
const announcementSchema = require("./CourseModels/AnnouncementSchema.model");
