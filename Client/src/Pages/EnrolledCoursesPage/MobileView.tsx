                            ...
                            <div className="flex flex-col items-start gap-4">
                                ...
                                <div className="flex-1 w-full">
                                    <div className="flex flex-col justify-between items-start mb-2 gap-2">
                                        ...
                                        <span className="bg-gray-700 text-orange-400 text-xs px-3 py-1 rounded-full self-start">
                                    ...
                                    <div className="flex flex-col justify-between items-center gap-4">
                                        <div className="flex items-center flex-wrap gap-x-4 gap-y-2 text-sm w-full">
                                        ...
                                        <button
                                            className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg text-sm flex items-center justify-center w-full transition-colors"
                                            onClick={(e) => {
                                                e.stopPropagation();
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex flex-col justify-between items-start mb-1 gap-2">
                                    ...
                                    {expandedCourse === course._id && (
                                        <div className="border-t border-gray-700 p-4">
                                            ...
                                            <div className="flex flex-col gap-3">
                                                <button
                                                    className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-3 rounded-lg font-medium flex-1 text-center transition-colors"
                                                    onClick={() => handleCourseNavigation(course._id)}
                                                >
                                                    Continue Learning
                                                </button>
                                                <button
                                                    className="border border-gray-600 hover:bg-gray-700 text-white px-4 py-3 rounded-lg font-medium flex-1 text-center transition-colors"
