        ...
        {[
          ...
          <button
            ...
            onClick={() => {
              ...
              navigate(tab.path || '/default-route');
            }}
          >
            {tab.icon}
      ...
      <aside className="w-64 bg-[#1D1D1D] p-6 sticky top-0 h-screen">
        ...
        <nav className="space-y-1 mb-8">
          {[
            ...
            { icon: <FiBook />, label: 'Continue Learning', value: 'learning', path:"/CourseContent" },
            { icon: <FiBook />, label: 'CourseDashboard', value:'dashboarad', path:'/EnrolledCoursesPage' },
            { icon: <FiCompass />, label: 'Discover', value: 'discover', path:"/BrowseCourses" }
          ].map(tab => (
            <button
              key={tab.value}
      ...
      <main className="flex-1 p-8">
        ...
        <section className="bg-gray-800 rounded-xl p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="/BrowseCourses" className="text-orange-500">Browse All</Link>
          </div>
