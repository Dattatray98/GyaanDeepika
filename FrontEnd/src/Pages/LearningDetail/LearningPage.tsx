...
import { 
  ...
  FiChevronDown, FiChevronUp, FiShare2} from 'react-icons/fi';
...
const LearningPage = () => {
  ...
  return (
    <div className="bg-[#0F0F0F] text-gray-100 min-h-screen">
      ...
      {/* Main Content */}
      <div className="max-W-[50vh] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-[#1A1A1A] rounded-xl p-6 border border-[#2A2A2A] shadow-lg mb-8">
          <h3 className="text-xl font-semibold text-white mb-4 flex items-center">
            <FaBrain className="mr-2 text-orange-400" />
            Ask Your Quries Related to Videos and Related to Your Studies
          </h3>
